...
namespace Ogu.Response.Json
{
    ...
    {
        public static IResponseResult JsonValidationFailure(this IResponseResultBuilder resultBuilder, IResponseValidationFailure validationFailure, string instance = null,
        ...
        public static IResponseResult JsonValidationFailure(this IResponseResultBuilder resultBuilder, IResponseValidationFailure[] validationFailures, string instance = null,
            string type = null, string code = null, int? status = 400, string title = "Bad Request",
            string detail = "One or more validation errors occurred.")
            => resultBuilder.ValidationFailure(JsonResponseError.Builder, validationFailures, instance, type, code, status, title, detail);

        public static IResponseResult JsonCustomFailure<TEnum>(this IResponseResultBuilder resultBuilder, TEnum @enum, string instance = null,
        ...
        public static IResponseResult JsonCustomFailure<TEnum>(this IResponseResultBuilder resultBuilder, TEnum[] @enums, string instance = null,
            string type = null, int? status = 400, string title = "Bad Request",
            string detail = "Custom failure occurred.")
            where TEnum : struct, System.Enum
            => resultBuilder.CustomFailure(JsonResponseError.Builder, enums, instance, type, status, title, detail);

        public static IResponseResult JsonCustomFailure(this IResponseResultBuilder resultBuilder, string error, string instance = null,
            string type = null, int? status = 400, string title = "Bad Request",
            string detail = "Custom failure occurred.")
            => resultBuilder.CustomFailure(JsonResponseError.Builder, error, instance, type, status, title, detail);

        public static IResponseResult JsonCustomFailure(this IResponseResultBuilder resultBuilder, string[] errors, string instance = null,
            string type = null, int? status = 400, string title = "Bad Request",
            string detail = "Custom failure occurred.")
            => resultBuilder.CustomFailure(JsonResponseError.Builder, errors, instance, type, status, title, detail);

        public static IResponseResult JsonExceptionFailure(this IResponseResultBuilder resultBuilder, Exception exception, bool includeTraces, string instance = null,
        ...
        public static IResponseResult JsonExceptionFailure(this IResponseResultBuilder resultBuilder, Exception[] exceptions, bool includeTraces, string instance = null,
            string type = null, int? status = 500, string title = "Internal Server Error", string detail = "Exception occurred.")
